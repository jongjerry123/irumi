...
public class ChatbotController {
			...
			HttpSession loginSession) 
	{
	  ...
	  // 유저가 대화 중 챗봇이 준 옵션 중 선택 후 제출한 경우 // 세션 정보에 따라 매니저 서비스 호출 -> 서비스에서 응답을 화면에 append 
	// 유저가 챗봇이 준 옵션 중 선택 후 제출한 경우 ===========================
	  ...
	  // handleChatbotOption: // 옵션 유형(대시보드 저장, 추가 추천 여부, 내용 추가 희망 여부)에 따라 // 다르게 동작하여 유저 선택에 대해 응답하도록 함. 
	  switch (topic) { case "job": responseDto =

...
public class GoogleOAuthService implements SocialOAuthService {
	...
	public SocialUserInfo getUserInfo(String code, HttpServletRequest request) throws Exception {
		...
		String redirectUri = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()
				+ request.getContextPath() + "/socialCallback.do?provider=google";
		...
		ResponseEntity<String> userResponse = restTemplate.exchange("https://www.googleapis.com/oauth2/v2/userinfo",

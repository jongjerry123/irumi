...
<body>
	...
	<div class="about-wrapper">
		...
		<div class="about-logo-container">
			<img src="/irumi/resources/images/ill.png" alt="이루미 로고"
				class="rotating-logo" />
		</div>
		<div class="container">
			<h2>회원가입</h2>
			<form id="register-form">
				...
				<button type="button" class="btn" id="complete-registration"
